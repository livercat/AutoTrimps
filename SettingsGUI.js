...
function initializeAllSettings() {
    ...
    createSetting('onlyminmaxworld', ['Min & Max: Everywhere', 'Max: World Only', 'Max: Corrupted Only', 'Max: Healthy Only'], 'Further restricts scrying usage based on the current world zone. Places set as MAYBE will always respect the Min range.<br><br><b>Everywhere:</b> Places set as MAYBE are affected by Min & Max Range.<br><b>World:</b> Only the World is affected by Max zones.<br><b>Corrupted:</b> Only Corrupted and Healthy enemies in the World are affected.<br><b>Healthy:</b> Only Healthy enemies in the World are affected.', 'multitoggle', 2, null, 'Scryer');
